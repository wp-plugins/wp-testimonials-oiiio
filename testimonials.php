...
Plugin URI: http://oiiio.us/testimonials/
...
{  
	add_options_page('wp testimonial', 'wp testimonial', 'manage_options', 'wp-testimonial-oiiio','oiiio_testimonials_options_page');  
} 
